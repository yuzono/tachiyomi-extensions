...
purposes. The actual implementations can be found [here](https://github.com/komikku-app/komikku/tree/master/app/src/main/java/eu/kanade/tachiyomi/source).
...
If you're running a Preview build of Komikku:

```
-W -S -n app.komikku.beta/eu.kanade.tachiyomi.ui.main.MainActivity -a eu.kanade.tachiyomi.SHOW_CATALOGUES
```

For other builds, replace the first `app.komikku.beta` with the corresponding package IDs:
- Release build: `app.komikku`
- Debug build: `app.komikku.dev`
