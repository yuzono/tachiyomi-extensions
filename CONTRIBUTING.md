...
free to report them through a [Meta Issue](https://github.com/yuzono/tachiyomi-extensions/issues/new?assignees=&labels=Meta+request&template=06_request_meta.yml)
...
- Join [the Discord server](https://discord.gg/85MZhUX688) for online help and to ask questions during
...
To get the current `id` value before a name change, search the source name in the [repository JSON file](https://github.com/yuzono/manga-repo/blob/repo/index.json)
