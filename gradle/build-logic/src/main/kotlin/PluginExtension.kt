    ...
    override fun apply(target: Project): Unit = with(target) {
        ...
        val versionCodeProvider = keiyoushi.theme.map { themeName ->
            ...
            themeKeiyoushi.baseVersionCode.get() + keiyoushi.versionCode.get() +
                // KMK -->
                themeKeiyoushi.kmkBaseVersionCode.getOrElse(0) + keiyoushi.kmkVersionCode.getOrElse(0)
        }.orElse(keiyoushi.versionCode.zip(keiyoushi.kmkVersionCode.orElse(0)) { v, kmk -> v + kmk })
        // KMK <--
